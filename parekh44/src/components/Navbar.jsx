    ...
    >
      ...
      >
        <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 flex justify-between items-center">
          ...
          {/* Logo Brand: THREADSPHERE Textile Retail */}
                        ...
                        return (
                          <Link
                            ...
                            style={{
                              ...
                              background: active ? 'rgba(141, 111, 151, 0.05)' : 'transparent',
                              textDecoration: 'none',
                              letterSpacing: '0.05em',
                            }}
                            onMouseEnter={e => {
                              e.currentTarget.style.background = 'rgba(141, 111, 151, 0.05)';
          ...
          >
            ...
            <div style={{ padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${C.border}` }}>
              ...
              <button
                ...
                style={{
                  width: 36, height: 36,
                  background: 'rgba(141, 111, 151, 0.1)',
                  border: 'none',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                {directNavItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        background: active ? 'rgba(141, 111, 151, 0.06)' : 'transparent',
                        color: active ? C.accent : C.primary,
                      }}
                    >
                      <span>{item.name}</span>
                        ...
                        {dropdownNavItems.map((item) => {
                          ...
                          return (
                            <Link
                              ...
                              style={{
                                background: active ? 'rgba(141, 111, 151, 0.04)' : 'transparent',
