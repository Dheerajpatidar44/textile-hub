              ...
              {["All", ...categories].map((cat) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: active ? 'rgba(141, 111, 151, 0.08)' : 'transparent',
                      color: active ? C.accent : C.stone,
                      border: 'none',
                    }}
                    onMouseEnter={e => { if (!active) { e.currentTarget.style.background = 'rgba(141, 111, 151, 0.04)'; e.currentTarget.style.color = C.accent; }}}
