...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, THREADSPHERE Textile Retail ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
              ...
              >
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: isOpen ? C.accent : 'rgba(141, 111, 151, 0.08)',
                    transition: 'all 0.3s ease',
                    borderRadius: '50%'
