      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 pt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left mb-20">
          {upcomingAuctions.map((auction) => (
            ...
            >
              <div className="w-full sm:w-[200px] h-[200px] sm:h-auto overflow-hidden shrink-0 bg-[#FAF9FC]">
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <span style={{ fontSize: 9, padding: '6px 12px', background: 'rgba(141, 111, 151, 0.08)', color: C.accent, fontWeight: 700, letterSpacing: '0.1em', borderRadius: '50px' }}>
                    {auction.id}
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12, marginBottom: 16 }}>
                  <div style={{ background: C.bg, padding: '10px 14px', borderRadius: 12 }}>
                    <p style={{ fontSize: 9, color: C.stone, textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 4px', fontWeight: 600 }}>Quantity</p>
            ...
            <div style={{ padding: '36px' }} className="text-left">
              <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                ...
                <div className="mt-4">
                  ...
                  <label
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.background = 'rgba(141, 111, 151, 0.04)';
                    }}
                    onMouseLeave={e => {
                  ...
                  >
                    ...
                    <p style={{ fontSize: 14, color: C.soil, margin: '0 0 4px', fontWeight: 600 }}>
                ...
                <div style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 16 }}>
                  ...
                  <a
                    href="mailto:hello@threadspheretextile.com"
