              ...
              <div className="flex-grow text-left pr-0 lg:pr-8">
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-3 mt-4">
                  {[
                    ...
                    { icon: Mail, val: 'careers@alankritthreads.com', href: 'mailto:careers@alankritthreads.com' },
                    ...
                    <div key={i} style={{ color: C.stone }} className="flex items-center gap-2 text-[12px] font-semibold">
                      ...
                      {href ? (
                        <a href={href} style={{ color: C.primary }} className="hover:text-[#BBA178] transition-colors">{val}</a>
                      ) : (
                        <span>{val}</span>
                      )}
                    </div>
