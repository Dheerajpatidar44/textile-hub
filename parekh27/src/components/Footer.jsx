...
export default function Footer() {
  return (
    <footer style={{ background: C.primary, color: '#faf8f5', fontFamily: "'DM Sans', sans-serif" }}>
      {/* Top Accent Strip */}
      <div style={{ height: 3, background: 'linear-gradient(90deg, #3d6966, #b56b46, #1c4442)' }} />
          ...
          <div className="col-span-2 lg:col-span-2">
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 4 }}>
                ...
                <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 11, fontWeight: 500, color: C.accent, letterSpacing: '0.15em' }}>
                  ESTD. 2005
                </span>
              </div>
