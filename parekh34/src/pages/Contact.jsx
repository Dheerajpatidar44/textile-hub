  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.bg, minHeight: '100vh' }} className="pt-[80px] pb-20">
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 text-left pt-0">
        ...
        {/* Map Section */}
        <div style={{ position: 'relative', borderRadius: 24, overflow: 'hidden', border: `1.5px solid ${C.border}`, boxShadow: '0 12px 32px rgba(74,25,66,0.06)', height: 400 }}>
          <iframe
        ...
        {/* Contact cards overlapping map */}
        <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto px-4 sm:px-6" style={{ marginTop: -70 }}>
          {contactDetails.map(({ icon: Icon, label, lines }, idx) => (
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 8px 24px rgba(74,25,66,0.08)',
              }}
            >
              <div 
                style={{ 
