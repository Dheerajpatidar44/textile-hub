      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(4, 62, 61, 0.45)', backdropFilter: 'blur(8px)' }}
          />
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 40px 80px rgba(4, 62, 61, 0.08)',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#043e3d', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(4, 62, 61, 0.05)'; }}
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C39A58" strokeWidth="1.5">
                  ...
                  <circle cx="12" cy="12" r="6" stroke="#043e3d" strokeWidth="1.2" />
              ...
              <h2 style={{
                ...
                color: '#043e3d', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#043e3d', margin: '0 0 16px', lineHeight: 1.2,
              ...
              <button
                ...
                onMouseLeave={e => { e.currentTarget.style.background = '#043e3d'; }}
              >
                Explore Collection
              </button>
            </div>
