...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, Paridhi Textiles ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
              ...
              >
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: isOpen ? C.accent : 'rgba(4, 62, 61, 0.08)',
                    transition: 'all 0.3s ease',
                    borderRadius: '50%'
