    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.bg, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 pt-0">
        ...
        <div className="text-left mb-8">
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 700, color: C.primary, margin: 0, display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left mb-20">
          {upcomingAuctions.map((auction) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group flex flex-col sm:flex-row overflow-hidden rounded-3xl"
              style={{
                background: 'white',
                border: `1px solid ${C.border}`,
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                boxShadow: '0 4px 20px rgba(4, 62, 61, 0.02)'
              }}
              onMouseEnter={e => {
                e.currentTarget.style.transform = 'translateY(-4px)';
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(4, 62, 61, 0.05)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(4, 62, 61, 0.02)';
              }}
            >
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <span style={{ fontSize: 9, padding: '6px 12px', background: 'rgba(4, 62, 61, 0.06)', color: C.primary, fontWeight: 700, letterSpacing: '0.1em', borderRadius: '50px' }}>
                    {auction.id}
                  </span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12, marginBottom: 16 }}>
                  <div style={{ background: C.bg, padding: '10px 14px', borderRadius: 16 }}>
        ...
        <motion.div
          ...
          style={{
            ...
            overflow: 'hidden',
            borderRadius: 24,
            boxShadow: '0 12px 40px rgba(4, 62, 61, 0.03)',
          }}
        >
            {/* Form Header */}
            <div style={{
              ...
              background: 'rgba(4, 62, 61, 0.04)',
              display: 'flex', alignItems: 'center', gap: 16,
            }} className="text-left">
              <div style={{
                width: 48, height: 48,
                background: 'white',
                border: `1px solid rgba(4, 62, 61, 0.1)`,
                ...
                <div className="mt-4">
                  ...
                  <label
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.background = 'rgba(4, 62, 61, 0.04)';
                    }}
                    onMouseLeave={e => {
