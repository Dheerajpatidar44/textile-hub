    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 pt-0">
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: C.stone, marginBottom: 40, fontWeight: 600, maxWidth: 560, margin: '0 auto 40px', lineHeight: 1.6 }}>
          Paridhi Textiles is administered and governed by highly skilled, experienced and qualified Management with decades of expertise in the textile industry.
        </p>
          ...
          {teamMembers.map((member, i) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(4, 62, 61, 0.04)';
              }}
              onMouseLeave={e => {
            ...
            >
              <div style={{ position: 'relative', display: 'inline-block', marginBottom: 18 }}>
                <img
                  ...
                  style={{
                    ...
                    objectFit: 'cover',
                    borderRadius: '50%',
                    border: `3px solid rgba(4, 62, 61, 0.15)`,
                    display: 'block',
                  }}
                />
              </div>
              ...
              <a
                href={`mailto:${member.name.toLowerCase().replace(' ', '')}@paridhitextiles.com`}
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: 6,
                  padding: '8px 16px',
                  fontSize: 11, color: C.primary, textDecoration: 'none', fontWeight: 700,
                  background: 'rgba(4, 62, 61, 0.08)',
                  border: `1px solid rgba(4, 62, 61, 0.15)`,
                  borderRadius: '50px',
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(4, 62, 61, 0.08)'; e.currentTarget.style.color = C.primary; e.currentTarget.style.borderColor = 'rgba(4, 62, 61, 0.15)'; }}
              >
