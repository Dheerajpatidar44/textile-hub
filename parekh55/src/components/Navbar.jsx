...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div 
        className="w-full px-4 sm:px-8 text-white text-[10px] sm:text-[11px] font-semibold tracking-wider flex justify-between items-center transition-all duration-500 ease-in-out overflow-hidden"
        style={{ 
          background: C.primary, 
          borderBottom: showTopBar ? `1px solid ${C.primaryDark}` : '0px solid transparent',
          maxHeight: showTopBar ? '40px' : '0px',
          opacity: showTopBar ? 1 : 0,
          paddingTop: showTopBar ? '8px' : '0px',
          paddingBottom: showTopBar ? '8px' : '0px',
        }}
      >
        ...
        <div className="flex items-center gap-2">
          {[
            ...
            <a
              ...
              className="w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 cursor-pointer text-white/70 hover:text-white hover:bg-white/10"
            >
              {social.svg}
            </a>
          ))}
      ...
      <div
        ...
        style={{
          ...
          borderBottom: `1px solid ${scrolled ? 'rgba(4, 62, 61, 0.08)' : 'rgba(4, 62, 61, 0.05)'}`,
