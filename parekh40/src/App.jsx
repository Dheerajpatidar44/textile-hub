      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(4, 59, 92, 0.7)', backdropFilter: 'blur(8px)' }}
          />
          ...
          >
            {/* Top bar */}
            <div style={{ height: 4, background: 'linear-gradient(90deg, #043B5C, #C29B62, #043B5C)' }} />
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#043B5C', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(4, 59, 92, 0.05)'; }}
            ...
            <div style={{ padding: '40px 32px 32px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#C29B62" strokeWidth="1.5">
              ...
              <h2 style={{
                ...
                color: '#043B5C', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#C29B62', margin: '0 0 16px', lineHeight: 1.25,
                letterSpacing: '0.08em',
              }}>
                SAUVORA
              </h2>

              <div style={{ width: 40, height: 2, background: 'rgba(194, 155, 98, 0.5)', margin: '0 auto 16px' }} />

              <p style={{ color: '#6B7280', fontSize: 14, lineHeight: 1.6, margin: '0 0 32px' }}>
                Discover our premium collection of heritage crafted textiles and elegant fabrics.
              </p>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#C29B62'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#043B5C'; }}
              >
                Explore Collection
              </button>
            </div>
