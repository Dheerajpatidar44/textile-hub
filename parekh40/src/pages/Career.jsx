    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.bg, minHeight: '100vh' }} className="pt-[40px] pb-20">
      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-14 pt-0">
        ...
        <div className="text-center mb-6">
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(30px, 4vw, 40px)', fontWeight: 600, color: C.soil, margin: '0 0 16px' }}>
            ...
            >
              <div>
                ...
                <div className="flex flex-col gap-3 mb-6">
                  ...
                  <div style={{ color: C.stone }} className="flex items-center gap-2.5 text-[13px] font-medium">
                    <Mail size={14} style={{ color: C.accent }} className="shrink-0" />
                    <a href="mailto:careers@sauvora.com" className="hover:opacity-85 transition-opacity">careers@sauvora.com</a>
                  </div>
                </div>
              ...
              <div className="pt-6 mt-4 flex flex-col gap-3" style={{ borderTop: `1px solid ${C.border}` }}>
                <button
                  className="w-full py-3 rounded-xl font-bold text-xs uppercase tracking-wider text-white transition-colors cursor-pointer"
                  style={{
