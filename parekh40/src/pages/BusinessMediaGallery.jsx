            ...
            >
              <div style={{ position: 'relative', aspectRatio: '4/3', overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  background: 'rgba(86, 81, 62, 0.85)', backdropFilter: 'blur(6px)', padding: '4px 10px',
                  borderRadius: 4
                }}>
                  <span style={{ fontSize: 9, color: '#FAF6F1', letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 600 }}>
                    {item.category}
                  </span>
                </div>
              </div>
              ...
              <div style={{ padding: '16px', flex: 1, textLeft: 'left', textAlign: 'left' }}>
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontWeight: 600, color: C.soil, margin: '0 0 6px', lineHeight: 1.4 }}>
                  {item.title}
                </h3>
