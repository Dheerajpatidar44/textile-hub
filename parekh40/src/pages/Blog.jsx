    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.cream, minHeight: '100vh' }} className="pt-[40px] pb-20">
      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-14 pt-0">
        ...
        <div className="text-center mb-6">
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(30px, 4vw, 44px)', fontWeight: 600, color: C.soil, margin: '0 0 16px' }}>Blog & Insights</h1>
          ...
          {posts.map((post, idx) => (
            ...
            >
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginTop: 'auto', paddingTop: 16, borderTop: `1px solid rgba(139,94,60,0.15)` }}>
