          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {quotations.map((item) => (
              ...
              >
                ...
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: C.soil, margin: '0 0 16px' }}>
                  {item.title}
                </h3>
            ...
            <div style={{ padding: '36px' }} className="text-left">
              <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                ...
                <div style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 16 }}>
                  ...
                  <a href="mailto:hello@varnikaweaves.com" style={{ fontSize: 13, color: C.primary, fontWeight: 500, textDecoration: 'none' }}>
