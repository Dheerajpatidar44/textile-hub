...
const C = {
  primary: '#043B5C',
  footerBg: '#2D2745', // Dark muted purple from the image
  accent: '#C29B62',
  border: '#EAEAEA',
...
export default function Footer() {
  return (
    <footer style={{
      ...
      {/* Top Wave */}
      <div style={{ position: 'absolute', top: -1, left: 0, width: '100%', overflow: 'hidden', lineHeight: 0, zIndex: 0 }}>
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ position: 'relative', display: 'block', width: 'calc(100% + 1.3px)', height: 40 }}>
      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-14 pt-24 pb-16" style={{ position: 'relative', zIndex: 1 }}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 text-left">
          ...
          <div className="col-span-1">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              <div style={{ width: 44, height: 44, background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, maxWidth: 290, marginBottom: 24 }}>
              We bring you closer to tradition with premium textiles crafted for every occasion.
            </p>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              {[
                ...
                <a
                  ...
                  style={{ width: 32, height: 32, background: 'transparent', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(255,255,255,0.5)', textDecoration: 'none', transition: 'all 0.3s ease' }}
          ...
          {/* ── QUICK LINKS ── */}
          <div className="col-span-1">
            <h4 style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, fontWeight: 700, color: 'white', marginBottom: 20, textTransform: 'uppercase' }}>
              Quick Links
            </h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <li key={link.name}>
                  <Link
                    to={link.path}
                    style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'all 0.2s ease', fontWeight: 500 }}
          ...
          <div className="col-span-1">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                ...
                { icon: Mail,   val: 'hello@sauvora.com',       href: 'mailto:hello@sauvora.com' },
              ].map(({ icon: Icon, val, href }, i) => (
                <a
                  key={i}
                  href={href}
                  style={{ display: 'flex', alignItems: 'flex-start', gap: 8, fontSize: 12, color: 'rgba(255,255,255,0.6)', textDecoration: 'none', lineHeight: 1.5, transition: 'color 0.2s ease' }}
                  onMouseEnter={e => e.currentTarget.style.color = 'white'}
                  onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}
                >
      ...
      {/* Bottom Bar */}
      <div style={{ position: 'relative', zIndex: 1, padding: '16px 0', textAlign: 'center' }}>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', margin: 0, fontWeight: 500 }}>
          © 2026 SAUVORA Textile Retail. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
