  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.bg, minHeight: '85vh' }} className="pt-2 pb-16">
      <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
        ...
        {/* Contact Layout */}
        <div className="bg-white rounded-[24px] border border-[#E8DDD0] shadow-sm overflow-hidden flex flex-col lg:flex-row">
          
          {/* Contact Details Panel */}
          <div className="w-full lg:w-[40%] p-8 lg:p-12" style={{ background: C.primary }}>
            <h2 className="text-[28px] font-bold text-white mb-8" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Get in Touch
            </h2>

            <div className="flex flex-col gap-8">
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 rounded-full shrink-0 flex items-center justify-center text-[#C8966A] bg-white/10">
                  <MapPin size={20} />
                </div>
                <div>
                  <h3 className="text-[14px] font-bold text-white mb-2 uppercase tracking-wider" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    Head Office
                  </h3>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1 text-[13.5px] text-white/80 font-medium">
                    <a href="tel:+919717543210" className="text-white hover:text-[#C8966A] transition-colors text-decoration-none">+91 97175 43210</a>
                    <a href="mailto:info@merakiethnic.com" className="text-white hover:text-[#C8966A] transition-colors text-decoration-none">info@merakiethnic.com</a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-[13.5px] leading-relaxed m-0 text-white/80 font-medium">
                    ...
                    <span className="text-[#C8966A] font-bold">Sunday: Closed</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              ...
              <div className="flex gap-4">
                {['Facebook', 'Instagram', 'Pinterest', 'Twitter'].map((s) => (
                  <a key={s} href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white text-[10px] hover:border-[#C8966A] hover:text-[#C8966A] transition-colors font-bold">
                    {s[0]}
                  </a>
                ))}
              </div>
          ...
          {/* Map Panel */}
          <div className="w-full lg:w-[60%] min-h-[400px] lg:min-h-full relative bg-[#F7F2EC]">
            <iframe
