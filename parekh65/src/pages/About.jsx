    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.bg, minHeight: '85vh' }} className="pt-2 pb-16">
      <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
        ...
        <motion.div
          ...
          className="relative bg-white rounded-[40px] overflow-hidden border border-[#E8DDD0] shadow-sm flex flex-col lg:flex-row"
        >
          {/* Image Side */}
          ...
          <div className="w-full lg:w-1/2 p-8 lg:p-14 flex flex-col justify-center text-left z-10 relative bg-white">
            ...
            <h2 className="text-[36px] lg:text-[44px] font-bold mb-6 leading-tight" style={{ color: C.primary, fontFamily: "'Cormorant Garamond', serif" }}>
              Weaving Tradition, <br />
              <span style={{ color: C.accent, fontStyle: 'italic' }}>Defining Future Style.</span>
            </h2>
