    ...
    >
      ...
      >
          ...
          {Array.from({ length: threadCount }).map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                right: 0,
                height: i % 3 === 0 ? 2 : 1,
                background: i % 2 === 0 ? '#C8966A' : '#FFFFFF',
        ...
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(#C8966A 1px, transparent 1px)`,
        ...
        <div className="relative flex flex-col items-center">
            ...
            >
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                <polygon points="24,4 28,20 44,24 28,28 24,44 20,28 4,24 20,20" 
                  stroke={C.gold} strokeWidth="1.5" fill="rgba(200,150,106,0.08)" />
                <circle cx="24" cy="24" r="6" fill="none" stroke={C.gold} strokeWidth="1" />
          ...
          <div className="relative w-48 h-[2px] rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.1)' }}>
            <motion.div
              ...
              style={{ background: `linear-gradient(90deg, ${C.gold}, #E8C490)` }}
              initial={{ width: 0 }}
