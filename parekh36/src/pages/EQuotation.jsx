              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', justify: 'space-between', marginBottom: 14 }}>
                  <span style={{
                    ...
                    background: 'rgba(168, 124, 94, 0.1)',
            ...
            <div style={{ padding: '32px' }} className="text-left">
              <form className="space-y-5" onSubmit={e => e.preventDefault()}>
                ...
                <button type="submit" style={{
                  ...
                  display: 'flex', alignItems: 'center', justify_content: 'center', gap: 8,
                ...
                <div style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                  ...
                  <a href="mailto:hello@aavanikatextiles.com" style={{ fontSize: 12, color: C.primary, fontWeight: 400, textDecoration: 'none' }}>
