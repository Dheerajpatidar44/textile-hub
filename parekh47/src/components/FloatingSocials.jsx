...
const COLORS = { 
  primary: '#A75D3F',        // Terracotta Accent
  accent: '#0D3E3C',         // Elegant Deep Teal
  bg: '#FAF8F5', 
  border: '#E5ECE9', 
  textDark: '#0D3E3C' 
};
    ...
    <div className="fixed left-0 top-[35%] z-[99] flex items-center">
      ...
      >
        ...
        <button
          ...
          className="absolute right-[-24px] top-1/2 -translate-y-1/2 w-6 h-10 flex items-center justify-center border-y border-r transition-colors focus:outline-none shadow-md cursor-pointer rounded-r-lg"
          style={{
