    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.bg, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="w-full md:w-[280px] flex-shrink-0 md:sticky md:top-[110px] p-4 md:p-6 rounded-xl shadow-sm" style={{ background: 'white', border: `1px solid ${C.border}` }}>
              ...
              {["All", ...categories].map((cat) => {
                ...
                return (
                  <button
                    ...
                    className="text-left whitespace-nowrap md:whitespace-normal w-auto md:w-full px-5 md:px-4 py-2 md:py-2.5 rounded-full md:rounded-2xl text-[12px] md:text-[13px] font-bold tracking-wide transition-all duration-200 cursor-pointer flex items-center justify-between flex-shrink-0"
                    style={{
          ...
          <div className="flex-1 w-full">
            ...
            {filteredProducts.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProducts.map((product, index) => (
                  <motion.div
                    ...
                    className="text-left group rounded-xl"
                  ...
                  >
                    <div style={{ height: 280, overflow: 'hidden', position: 'relative' }}>
                      ...
                      />
                      <div className="absolute inset-0 bg-[#1E3E37]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                    </div>
              ...
              <div style={{ textAlign: 'center', padding: '100px 24px', background: 'white', borderRadius: 12, border: `1px solid ${C.border}` }}>
