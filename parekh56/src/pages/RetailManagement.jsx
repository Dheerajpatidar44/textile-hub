        ...
        >
          {teamMembers.map((member, i) => (
            ...
            >
              <div style={{ position: 'relative', display: 'inline-block', marginBottom: 18 }}>
                <img
                  ...
                  style={{
                    ...
                    objectFit: 'cover',
                    borderRadius: '50%',
                    border: `3px solid rgba(26, 79, 79, 0.15)`,
                    display: 'block',
                  }}
                />
              </div>
              ...
              <a
                href={`mailto:${member.name.toLowerCase().replace(' ', '')}@sutradharhub.com`}
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: 6,
                  padding: '8px 16px',
                  fontSize: 11, color: C.primary, textDecoration: 'none', fontWeight: 700,
                  background: 'rgba(26, 79, 79, 0.08)',
                  border: `1px solid rgba(26, 79, 79, 0.15)`,
                  borderRadius: 8,
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(26, 79, 79, 0.08)'; e.currentTarget.style.color = C.primary; e.currentTarget.style.borderColor = 'rgba(26, 79, 79, 0.15)'; }}
              >
