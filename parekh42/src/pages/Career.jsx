        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          {jobs.map((job, idx) => (
            <motion.div
              ...
              key={job.id}
              className="flex flex-col justify-between p-8 bg-white border border-[#EAE5DE] rounded-[16px] transition-all duration-300"
              onMouseEnter={e => {
            ...
            >
              <div>
                <h3 style={{ fontFamily: "'Playfair Display', serif", color: C.soil }} className="text-[17px] font-bold mb-5 leading-snug">
                  {job.title}
                </h3>
                ...
                <p style={{ color: C.stone }} className="text-[13px] leading-relaxed mb-4">
                  {job.description}
                </p>
              </div>
              ...
              <div className="pt-6 mt-4 flex flex-col gap-3" style={{ borderTop: `1px solid ${C.border}` }}>
                <button
                  className="w-full py-3 rounded-lg font-bold text-xs uppercase tracking-wider text-white transition-all cursor-pointer"
                  style={{
                ...
                <a
                  href="mailto:careers@loomcraftindia.com"
