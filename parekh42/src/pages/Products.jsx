...
export default function Products() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.bg, minHeight: '100vh' }} className="pt-[110px] pb-20">
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 mb-8">
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14">
        ...
        <div style={{ background: 'white', border: `1px solid ${C.border}`, borderRadius: 16, padding: '20px', marginBottom: 28, boxShadow: '0 4px 16px rgba(163, 112, 76, 0.04)' }}>
            ...
            {["All", ...categories].map((cat) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={e => {
                    if (!active) {
                      e.currentTarget.style.background = 'rgba(163,112,76,0.05)';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product, index) => (
                <motion.div
                  ...
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 12px 30px rgba(163,112,76,0.08)'; }}
                ...
                >
                  ...
                  <div style={{ padding: '16px', borderTop: `1px solid ${C.border}` }}>
                    ...
                    <h3 style={{ fontSize: 14.5, fontWeight: 700, color: C.soil, margin: '0 0 12px', lineHeight: 1.4, fontFamily: "'Playfair Display', serif" }}>
                      {product.name}
                    </h3>
                    <button
                      style={{
