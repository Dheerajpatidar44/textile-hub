            ...
            >
              <div style={{ position: 'relative', aspectRatio: '4/3', overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  background: 'rgba(35, 31, 32, 0.85)', backdropFilter: 'blur(6px)',
                  borderRadius: 20, padding: '3px 10px',
                  border: '1px solid rgba(255, 255, 255, 0.1)',
                }}>
                  <span style={{ fontSize: 8.5, color: '#FAF8F5', letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: 600 }}>
                    {item.category}
                  </span>
                </div>
              </div>
              ...
              <div style={{ padding: '16px', flex: 1, textAlign: 'left' }}>
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontWeight: 700, color: C.soil, margin: '0 0 6px', lineHeight: 1.35 }}>
                  {item.title}
                </h3>
