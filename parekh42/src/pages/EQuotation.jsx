      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
            {quotations.map((item) => (
              ...
              >
                ...
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 600, color: C.soil, margin: '0 0 10px' }}>
                  {item.title}
                </h3>
        ...
        >
          <div style={{
            ...
            border: `1px solid ${C.border}`,
            overflow: 'hidden',
            boxShadow: '0 8px 24px rgba(163, 112, 76, 0.04)',
          }}>
            {/* Form header */}
            <div style={{
              padding: '24px 32px',
              ...
              <div style={{
                ...
                border: `1px solid rgba(163, 112, 76, 0.35)`,
            ...
            <div style={{ padding: '32px' }} className="text-left">
              <form className="space-y-5" onSubmit={e => e.preventDefault()}>
                ...
                <div style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justify: 'center', gap: 8 }}>
                  ...
                  <a href="mailto:hello@loomcraftindia.com" style={{ fontSize: 12.5, color: C.primary, fontWeight: 600, textDecoration: 'none' }}>
                    hello@loomcraftindia.com
                  </a>
                </div>
              </form>
            </div>
