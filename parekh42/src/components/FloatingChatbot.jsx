    ...
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      {isOpen && (
        <div
          ...
          style={{ borderColor: C.border, background: '#FAF8F5', boxShadow: '0 12px 40px rgba(163,112,76,0.12)' }}
        >
          {/* Header */}
          <div
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 animate-pulse"
                style={{ background: C.accent }}
              >
                <Sparkles size={15} color="white" />
              </div>
              <div className="text-left">
                <p className="text-[#FAF8F5] text-[13px] font-bold tracking-wide leading-tight">
                  LoomCraft India Assistant
                </p>
                <div className="flex items-center gap-1.5 mt-0.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span className="text-[10px] tracking-wide" style={{ color: 'rgba(250,248,245,0.7)' }}>
            ...
            <div className="flex items-start gap-2.5 mb-4">
              ...
              >
                <p className="text-[13px] leading-relaxed" style={{ color: C.soil }}>
                  Namaste! 🙏 Welcome to <strong>LoomCraft India</strong>. How can I assist you today?
                </p>
              </div>
            </div>
      ...
      <button
        ...
        className="w-[52px] h-[52px] rounded-xl flex items-center justify-center cursor-pointer transition-all duration-300 border shadow-md"
        style={{
