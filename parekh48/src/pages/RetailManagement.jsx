    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 pt-0">
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: C.stone, marginBottom: 40, fontWeight: 600, maxWidth: 560, margin: '0 auto 40px', lineHeight: 1.6 }}>
          The Fabric Atelier is administered and governed by highly skilled, experienced and qualified Management with decades of expertise in the textile industry.
        </p>
          ...
          {teamMembers.map((member, i) => (
            ...
            >
              <div style={{ position: 'relative', display: 'inline-block', marginBottom: 18 }}>
                <img
                  ...
                  style={{
                    ...
                    objectFit: 'cover',
                    borderRadius: '50%',
                    border: `3px solid rgba(37, 82, 75, 0.15)`,
                    display: 'block',
                  }}
                />
              </div>
              ...
              <a
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(37, 82, 75, 0.08)'; e.currentTarget.style.color = C.primary; e.currentTarget.style.borderColor = 'rgba(37, 82, 75, 0.15)'; }}
              >
