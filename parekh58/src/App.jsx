      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(92, 12, 47, 0.25)', backdropFilter: 'blur(8px)' }}
          />
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 40px 80px rgba(92, 12, 47, 0.12)',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#5F5558', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                borderRadius: '50%',
                background: 'rgba(126, 18, 66, 0.08)', }}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#Bfa37c" strokeWidth="1.5">
                  <circle cx="12" cy="12" r="9" stroke="#Bfa37c" strokeWidth="1.5" />
                  <path d="M12 2v20M2 12h20M5 5l14 14M5 19L14 10" stroke="#7E1242" strokeWidth="1" />
                  <circle cx="12" cy="12" r="4" fill="#7E1242" />
                </svg>
              </div>
              ...
              <h2 style={{
                ...
                color: '#C17D91', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#7E1242', margin: '0 0 6px', lineHeight: 1.2,
              ...
              <h3 style={{
                ...
                color: '#5F5558', margin: '0 0 18px', lineHeight: 1.2,
              ...
              <div style={{ width: 48, height: 1.5, background: '#Bfa37c', margin: '0 auto 20px' }} />

              <p style={{ color: '#5F5558', fontSize: 13.5, lineHeight: 1.6, margin: '0 0 32px', fontWeight: 500 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#5C0C2F'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#7E1242'; }}
              >
                Explore Collection
              </button>
            </div>
