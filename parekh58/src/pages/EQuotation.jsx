              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', justify: 'space-between', marginBottom: 16 }}>
                  <span style={{
                    ...
                    padding: '6px 12px',
                    background: 'rgba(126, 18, 66, 0.06)',
            ...
            <div style={{ padding: '36px' }} className="text-left">
              <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                ...
                <button type="submit" style={{
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = C.primaryDark; e.currentTarget.style.color = 'white'; }}
                ...
                <div style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justify: 'center', gap: 8, marginTop: 16 }}>
                  ...
                  <a href="mailto:hello@kasturitextile.com" style={{ fontSize: 13, color: C.primary, fontWeight: 600, textDecoration: 'none' }}>
