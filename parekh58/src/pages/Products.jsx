      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="w-full md:w-[280px] flex-shrink-0 md:sticky md:top-[110px] p-4 md:p-6 rounded-2xl shadow-sm" style={{ background: 'white', border: `1px solid ${C.border}` }}>
            <h3 className="hidden md:block" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 24, fontWeight: 700, color: C.primary, marginBottom: 16, paddingBottom: 12, borderBottom: `1px solid ${C.border}` }}>
              Categories
            </h3>
              ...
              {["All", ...categories].map((cat) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: active ? 'rgba(126, 18, 66, 0.08)' : 'transparent',
                      color: active ? C.primary : C.stone,
                      border: 'none',
                    }}
                    onMouseEnter={e => { if (!active) { e.currentTarget.style.background = 'rgba(126, 18, 66, 0.04)'; e.currentTarget.style.color = C.primary; }}}
                ...
                {filteredProducts.map((product, index) => (
                  <motion.div
                    ...
                    style={{ overflow: 'hidden',
                      ...
                      boxShadow: '0 4px 20px rgba(126,18,66,0.02)'
                    }}
                  >
                    <div style={{ height: 280, overflow: 'hidden', position: 'relative' }}>
                      ...
                      />
                      <div className="absolute inset-0 bg-[#7E1242]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                    </div>
