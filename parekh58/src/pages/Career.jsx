          ...
          {jobs.map((job, idx) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(126, 18, 66, 0.04)';
              }}
              onMouseLeave={e => {
              ...
              <div>
                ...
                <div className="flex flex-col gap-3 mb-6">
                  {[
                    ...
                    { icon: Mail, val: 'careers@kasturitextile.com', href: 'mailto:careers@kasturitextile.com' },
                    ...
                    <div key={val} style={{ color: C.stone }} className="flex items-center gap-2.5 text-[12.5px] font-semibold">
                      ...
                      {href ? (
                        <a href={href} style={{ color: C.primary }} className="hover:text-[#C17D91] transition-colors">{val}</a>
                      ) : (
                        <span>{val}</span>
                      )}
                    </div>
