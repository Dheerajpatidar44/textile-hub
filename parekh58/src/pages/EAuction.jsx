      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 pt-0">
          ...
          {upcomingAuctions.map((auction) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(126, 18, 66, 0.05)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(126, 18, 66, 0.02)';
              }}
            >
              <div className="w-full sm:w-[200px] h-[200px] sm:h-auto overflow-hidden shrink-0 bg-[#FAF5F7]">
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', alignItems: 'center', justify: 'space-between', marginBottom: 12 }}>
                  <span style={{ fontSize: 9, padding: '6px 12px', background: 'rgba(126, 18, 66, 0.06)', color: C.primary, fontWeight: 700, letterSpacing: '0.1em', borderRadius: '50px' }}>
                    {auction.id}
                  </span>
        ...
        <motion.div
          ...
          style={{
            ...
            overflow: 'hidden',
            borderRadius: 20,
            boxShadow: '0 12px 40px rgba(126, 18, 66, 0.03)',
          }}
        >
            {/* Form Header */}
            <div style={{
              ...
              background: 'rgba(126, 18, 66, 0.03)',
              display: 'flex', alignItems: 'center', gap: 16,
            }} className="text-left">
              <div style={{
                width: 48, height: 48,
                background: 'white',
                border: `1px solid rgba(126, 18, 66, 0.1)`,
                ...
                <div className="mt-4">
                  ...
                  <label
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.background = 'rgba(126, 18, 66, 0.04)';
                    }}
                    onMouseLeave={e => {
