    ...
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'Outfit', sans-serif" }}>
      {isOpen && (
        <div
          ...
          style={{ borderColor: C.border, background: '#FAF5F7', boxShadow: '0 16px 48px rgba(126, 18, 66, 0.12)' }}
        >
          {/* Header */}
          <div
          ...
          <div className="p-5 h-64 overflow-y-auto" style={{ background: C.cream }}>
            <div className="flex items-start gap-2.5 mb-4">
              ...
              <div
                className="px-4 py-3 rounded-xl rounded-tl-none max-w-[82%] bg-[#FAF5F7] text-left border"
                style={{ borderColor: C.border }}
              >
                <p className="text-[13px] leading-relaxed" style={{ color: C.stone }}>
                  Namaste! 🙏 Welcome to <strong>KASTURI Textile Retail Mall</strong>. How can I assist you today?
                </p>
              </div>
            </div>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 4px 16px rgba(126, 18, 66, 0.2)'
        }}
      >
        {isOpen ? (
