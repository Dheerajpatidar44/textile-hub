...
const C = {
  ...
  primaryDark: '#5C0C2F',   // Darker Burgundy
  primaryLight: '#9C2A5C',  // Lighter Burgundy
  accent: '#C17D91',        // Dusty Rose
  accentLight: '#FAF5F7',   // Tinted Cream
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: scrolled ? 'rgba(126, 18, 66, 0.95)' : C.primary,
      ...
      >
        <div className="max-w-[95rem] mx-auto px-4 sm:px-8 lg:pl-6 lg:pr-14 flex justify-between items-center">
          ...
          {/* Logo Brand: KASTURI Textile Retail Mall */}
              ...
              return (
                <Link
                  ...
                  className={`px-1 pb-1 mx-2 text-[12px] xl:text-[13px] font-bold tracking-widest transition-all duration-300 whitespace-nowrap shrink-0 ${
                    active ? 'text-[#Bfa37c]' : 'text-white/80 hover:text-[#Bfa37c]'
                  }`}
                  style={{
            ...
            >
              <button
                className={`flex items-center gap-1 px-1 pb-1 mx-2 text-[12px] xl:text-[13px] font-bold tracking-widest transition-all duration-300 whitespace-nowrap cursor-pointer bg-transparent border-none ${
                  isDropdownActive() ? 'text-[#Bfa37c]' : 'text-white/80 hover:text-[#Bfa37c]'
                }`}
                style={{
                  borderBottom: '2px solid transparent',
                  borderRadius: 0,
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{ background: C.primary, fontFamily: "'Outfit', sans-serif" }}
          >
            {/* Drawer header (Fixed, no shrink) */}
            <div style={{ flexShrink: 0, padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <div className="w-full">
                  <button
                    ...
                    style={{
                      color: isDropdownActive() ? C.gold : 'rgba(255, 255, 255, 0.85)',
                    }}
                  >
                    <span>PAGES</span>
            ...
            <div className="px-6 py-6 border-t border-white/10 flex items-center justify-center gap-4 bg-black/10" style={{ flexShrink: 0 }}>
              {[
