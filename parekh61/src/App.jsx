          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#4A4A4A', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifycontent: 'center',
                borderRadius: '50%',
                background: 'rgba(28, 54, 43, 0.1)', }}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#1C362B" strokeWidth="1.5">
                  <circle cx="12" cy="12" r="9" stroke="#1C362B" strokeWidth="1.5" />
                  <path d="M12 2v20M2 12h20M5 5l14 14M5 19L14 10" stroke="#1C362B" strokeWidth="1" />
                  <circle cx="12" cy="12" r="4" fill="#1C362B" />
                </svg>
              </div>
              ...
              <h2 style={{
                ...
                color: '#1C362B', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#1C362B', margin: '0 0 6px', lineHeight: 1.2,
              ...
              <h3 style={{
                ...
                color: '#4A4A4A', margin: '0 0 18px', lineHeight: 1.2,
              ...
              <p style={{ color: '#4A4A4A', fontSize: 13.5, lineHeight: 1.6, margin: '0 0 32px', fontWeight: 500 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#2A4F40'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#1C362B'; }}
              >
                Explore Collection
              </button>
            </div>
