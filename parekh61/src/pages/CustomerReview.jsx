    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 lg:px-14 pt-0">
        ...
        <div className="text-center mb-10 mt-2">
          <span className="text-[10px] font-bold tracking-[0.25em] text-[#D79F88] uppercase block mb-1">REVIEWS</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, idx) => (
            <motion.div
              ...
              className="bg-white rounded-2xl border border-[#E8D5C4] p-8 text-left shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow duration-300"
            >
              ...
              <div className="flex items-center gap-3.5 pt-6 mt-6 border-t border-[#E8D5C4]/45">
                {review.avatar ? (
                  ...
                  <div 
                    ...
                    style={{ background: 'rgba(10, 24, 40, 0.08)', color: C.accent }}
                  >
                    <User size={16} />
                  </div>
                )}
                <div>
                  <h4 className="text-[12.5px] font-bold text-[#0a1828] m-0">{review.name}</h4>
