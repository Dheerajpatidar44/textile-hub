    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.bg, minHeight: '85vh' }} className="pt-2 pb-16">
      <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-6 sm:p-8 lg:p-10 border border-[#D5DBCB] shadow-sm grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-stretch"
        >
          {/* Main Image Container with offset rectangle Shape */}
          <div className="relative w-full h-full min-h-[350px] lg:min-h-full rounded-2xl overflow-hidden shadow-sm border border-[#D5DBCB]">
            <img
              src="/images/kumavati_about.png"
              alt="Kumavati Textile Craftsmanship"
              className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#1C362B]/60 to-transparent flex flex-col justify-end p-8 text-white">
          ...
          <div className="flex flex-col justify-center text-left py-4 lg:py-8 pr-0 lg:pr-8">
            <span className="text-[11px] font-bold tracking-[0.2em] text-[#B8A9CB] uppercase mb-2 block">Our Heritage</span>
            <h2 className="text-[32px] lg:text-[40px] font-bold mb-6 leading-tight text-[#1C362B] font-serif">
              Weaving Tradition, <br />
              <span className="text-[#Bfa37c]">Defining Future Style.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 border-t border-[#D5DBCB] pt-8">
              <div>
                <h4 className="text-[14px] font-bold text-[#1C362B] uppercase mb-2 font-sans tracking-wide">Authentic Quality</h4>
              ...
              <div>
                <h4 className="text-[14px] font-bold text-[#1C362B] uppercase mb-2 font-sans tracking-wide">Modern Procurement</h4>
