              ...
              {["All", ...categories].map((cat) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: active ? 'rgba(10, 24, 40, 0.08)' : 'transparent',
                      color: active ? C.primary : C.stone,
                      border: 'none',
                    }}
                    onMouseEnter={e => { if (!active) { e.currentTarget.style.background = 'rgba(10, 24, 40, 0.04)'; e.currentTarget.style.color = C.primary; }}}
                ...
                {filteredProducts.map((product, index) => (
                  ...
                  >
                    <div style={{ height: 280, overflow: 'hidden', position: 'relative' }}>
                      ...
                      />
                      <div className="absolute inset-0 bg-[#0a1828]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                    </div>
