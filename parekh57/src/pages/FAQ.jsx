  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-3xl mx-auto px-6 pt-0">
              ...
              >
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: isOpen ? C.accent : 'rgba(26, 79, 79, 0.08)',
                    transition: 'all 0.3s ease',
                    borderRadius: '50%'
        ...
        <div style={{ marginTop: 40, textAlign: 'center', padding: '24px', background: 'white', border: `1px solid ${C.border}`, borderRadius: 12 }}>
