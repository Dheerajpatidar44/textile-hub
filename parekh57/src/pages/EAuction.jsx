      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 pt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left mb-20">
          {upcomingAuctions.map((auction) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group flex flex-col sm:flex-row overflow-hidden rounded-xl"
              style={{
                background: 'white',
                border: `1px solid ${C.border}`,
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                boxShadow: '0 4px 20px rgba(26, 79, 79, 0.02)'
              }}
              onMouseEnter={e => {
                e.currentTarget.style.transform = 'translateY(-4px)';
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(26, 79, 79, 0.05)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(26, 79, 79, 0.02)';
              }}
            >
        ...
        <motion.div
          ...
          style={{
            ...
            overflow: 'hidden',
            borderRadius: 12,
            boxShadow: '0 12px 40px rgba(26, 79, 79, 0.03)',
          }}
        >
            {/* Form Header */}
            <div style={{
