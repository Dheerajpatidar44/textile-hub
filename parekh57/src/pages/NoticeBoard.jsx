        ...
        >
          {notices.map((notice) => (
            <div
              ...
              onMouseEnter={e => {
                e.currentTarget.style.background = 'rgba(26, 79, 79, 0.04)';
            ...
            >
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                  <div style={{ width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(26, 79, 79, 0.08)', borderRadius: '50%' }}>
