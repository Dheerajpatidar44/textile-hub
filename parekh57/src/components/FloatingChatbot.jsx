...
const FloatingChatbot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'Outfit', sans-serif" }}>
      {isOpen && (
        <div
          className="mb-4 w-[340px] sm:w-[370px] overflow-hidden border rounded-xl"
          style={{ borderColor: C.border, background: '#FAF8F5', boxShadow: '0 16px 48px rgba(26, 79, 79, 0.12)' }}
        >
          {/* Header */}
          <div
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 4px 16px rgba(26, 79, 79, 0.2)'
        }}
      >
        {isOpen ? (
