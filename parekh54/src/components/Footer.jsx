...
const C = {
  ...
  primaryDark: '#3D0B15',
  primaryLight: '#7A2A39',
  accent: '#C2A478',         // Muted Gold Accent
  gold: '#C2A478',
  border: '#E6E1D8',
  bg: '#FAF6F0',
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 text-left">
          ...
          <div className="col-span-1">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                { icon: MapPin, val: 'The Textile Loft, 456, Textile Boulevard, Surat, Gujarat - 395002', href: '#' },
                { icon: Phone, val: '1800 123 4567', href: 'tel:18001234567' },
                { icon: Mail, val: 'info@thetextileloft.com', href: 'mailto:info@thetextileloft.com' },
      ...
      <div style={{ borderTop: `1px solid rgba(255,255,255,0.05)`, position: 'relative', zIndex: 1, background: 'rgba(0,0,0,0.1)' }}>
        <div className="max-w-[90rem] mx-auto px-6 lg:px-14 py-6 flex flex-col md:flex-row items-center justify-between text-center">
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', margin: 0, fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
            © 2026 The Textile Loft. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
