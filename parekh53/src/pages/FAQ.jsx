...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, Aura Weaves ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-3xl mx-auto px-6 pt-0">
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3 style={{ fontFamily: "'Cinzel', serif", fontSize: 18, fontWeight: isOpen ? 700 : 600, color: C.soil, margin: 0, lineHeight: 1.4, transition: 'all 0.2s ease' }}>
                    {faq.question}
                  </h3>
                  <div style={{
                    flexShrink: 0, width: 32, height: 32,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    background: isOpen ? C.accent : 'rgba(226, 184, 101, 0.08)',
                    transition: 'all 0.3s ease',
                    borderRadius: '0px'
                  }} className="flex items-center justify-center">
                    {isOpen ? <Minus size={14} color="#12151c" /> : <Plus size={14} color={C.accent} />}
                  </div>
                </button>
        ...
        <div style={{ marginTop: 40, textAlign: 'center', padding: '24px', background: '#1b202c', border: `1px solid ${C.border}`, borderRadius: '0px' }}>
