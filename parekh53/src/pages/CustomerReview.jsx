...
const reviews = [
  { text: "Aura Weaves has been our trusted partner for years. The quality, and B2B quotation services are unmatched in the entire industry.", name: "Rajesh Sharma", role: "Retailer, Delhi", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" },
            ...
            >
              <div>
                ...
                <div style={{
                  ...
                  fontSize: 70, color: 'rgba(226, 184, 101, 0.08)', lineHeight: 1, fontWeight: 700,
                  userSelect: 'none',
                }}>
                  "
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                {review.avatar ? (
                  <img
                    src={review.avatar}
                    alt={review.name}
                    style={{ width: 36, height: 36, borderRadius: '0px', objectFit: 'cover', border: `1px solid ${C.border}` }}
                  />
                ) : (
                  <div style={{
                    width: 36, height: 36,
