...
const C = {
  primary: '#12151c',        // Active text color (dark charcoal)
  primaryLight: '#e2b865',   // Active background (gold)
  primaryDark: '#0a0c10',    // Darkest
  accent: '#e2b865',         // Gold Accent
  bg: '#1b202c',             // Sidebar background
...
export default function Navbar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full select-none py-6 px-4 bg-transparent">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-3.5 px-4 py-2.5 rounded-none text-[13px] font-medium tracking-wide transition-all duration-300"
              style={{
              ...
              onMouseEnter={e => {
                if (!active) {
                  ...
                  e.currentTarget.style.color = '#e2b865';
                }
              }}
              onMouseLeave={e => {
                if (!active) {
      ...
      <div className="pt-4 border-t border-[rgba(255,255,255,0.08)] mt-auto flex items-center justify-center gap-6">
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[rgba(255,255,255,0.6)] hover:text-[#e2b865] hover:scale-110 transition-all duration-300">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
        </a>
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[rgba(255,255,255,0.6)] hover:text-[#e2b865] hover:scale-110 transition-all duration-300">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
        </a>
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-[rgba(255,255,255,0.6)] hover:text-[#e2b865] hover:scale-110 transition-all duration-300">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
        </a>
        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[rgba(255,255,255,0.6)] hover:text-[#e2b865] hover:scale-110 transition-all duration-300">
  ...
  return (
    <aside
      ...
      style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: C.bg, borderRight: `1px solid ${C.border}` }}
    >
      <SidebarContent />
    </aside>
  );
