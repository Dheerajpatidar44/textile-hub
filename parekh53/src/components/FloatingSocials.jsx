  ...
  return (
    <div className="fixed left-0 top-[35%] z-[99] flex items-center">
      <motion.div
        ...
        className="flex flex-col items-center shadow-2xl py-5 px-3.5 relative rounded-none"
        style={{
          background: '#1b202c',
      ...
      >
        ...
        <button
          ...
          className="absolute right-[-24px] top-1/2 -translate-y-1/2 w-6 h-10 flex items-center justify-center border-y border-r transition-colors focus:outline-none shadow-md cursor-pointer rounded-none"
          style={{
          ...
          onMouseLeave={e => { e.currentTarget.style.background = COLORS.accent; e.currentTarget.style.color = COLORS.primary; }}
