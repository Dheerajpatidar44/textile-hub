...
export default function Layout() {
  return (
    <div className="flex flex-col min-h-screen bg-sand text-[#e2e8f0] relative">
      ...
      <header 
        ...
        style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#12151c', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}
      >
        <div className="flex items-center gap-3">
          {/* Elegant Mandala Brand Icon */}
          <div className="w-11 h-11 text-[#e2b865] flex items-center justify-center">
          ...
          <div className="flex flex-col text-left">
            <span 
              className="text-[22px] font-bold tracking-[0.05em] text-[#e2b865] uppercase leading-none"
              style={{ fontFamily: "'Cinzel', serif" }}
            >
              AURA WEAVES
            </span>
            <span className="text-[8px] tracking-[0.25em] text-[#a0aec0] font-bold uppercase leading-none mt-1">
        ...
        <Link
          ...
          onMouseLeave={e => {
            e.currentTarget.style.background = '#e2b865';
            e.currentTarget.style.color = '#12151c';
      ...
      <div className="flex flex-row flex-grow pt-16 w-full relative">
        ...
        <div className="flex-grow flex flex-col min-h-[calc(100vh-64px)] pl-[280px] w-full">
          {/* Page contents with edge-to-edge availability */}
