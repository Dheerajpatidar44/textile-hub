          ...
          >
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifycontent: 'center',
                borderRadius: '50%',
                background: 'rgba(186, 163, 124, 0.15)', }}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#Bfa37c" strokeWidth="1.5">
                  ...
                  <path d="M12 2v20M2 12h20M5 5l14 14M5 19L14 10" stroke="#0a1828" strokeWidth="1" />
                  <circle cx="12" cy="12" r="4" fill="#0a1828" />
                </svg>
              </div>
              ...
              <h2 style={{
                ...
                color: '#D79F88', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#0a1828', margin: '0 0 6px', lineHeight: 1.2,
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#162a43'; }}
