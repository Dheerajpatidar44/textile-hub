  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="py-2.5 px-6 sm:px-8 lg:px-14 flex flex-col sm:flex-row justify-between items-center gap-2"
      >
        ...
        <div className="flex items-center gap-4 text-[10.5px]">
          <span>GST No: 24AAACT0012K1ZS</span>
          <span style={{ color: C.border }}>|</span>
          <span>Helpline: 1800 120 4567</span>
        </div>
        <div className="flex items-center gap-3.5">
          <a href="#" className="transition-colors hover:opacity-75" style={{ color: '#556652' }} aria-label="Facebook">
          ...
          <a href="#" className="transition-colors hover:opacity-75" style={{ color: '#556652' }} aria-label="Instagram">
          ...
          <a href="#" className="transition-colors hover:opacity-75" style={{ color: '#556652' }} aria-label="LinkedIn">
          ...
          <a href="#" className="transition-colors hover:opacity-75" style={{ color: '#556652' }} aria-label="Pinterest">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 12a4 4 0 1 1 8 0 4 4 0 0 1-8 0z"/><path d="M12 8v8"/></svg>
          </a>
          <a href="#" className="transition-colors hover:opacity-75" style={{ color: '#556652' }} aria-label="YouTube">
