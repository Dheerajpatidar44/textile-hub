...
export default function Navbar() {
  ...
  return (
    <header
      className="w-full fixed top-0 left-0 z-50 transition-all duration-300 rounded-full"
    ...
    >
      ...
      <div
        ...
        style={{
          background: scrolled ? 'rgba(26, 42, 68, 0.98)' : C.primary,
        ...
        <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group shrink-0 text-left">
            ...
            <div style={{
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#B56A79" strokeWidth="2">
            ...
            <div className="flex flex-col">
              <span
                ...
                style={{ fontFamily: "'Playfair Display', serif", letterSpacing: '0.05em', color: 'white' }}
              >
                Varnika Weaves
              </span>
              <span className="text-[8px] tracking-[0.15em] font-medium mt-1 uppercase" style={{ color: 'rgba(255,255,255,0.6)' }}>
                Textile Studio
              </span>
            </div>
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-x-6">
            {directNavItems.filter(item => item.name !== 'Trade Enquiry').map((item) => {
              ...
              return (
                <Link
                  ...
                  style={{ color: active ? C.accent : 'white' }}
                >
                  {item.name}
                  {active && (
            ...
            >
              <button
                ...
                style={{ color: isDropdownActive() ? C.accent : 'white' }}
              >
                <span>More</span>
              ...
              <AnimatePresence>
                {dropdownOpen && (
                  <motion.div
                    ...
                    className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-56  shadow-2xl z-[999] text-left overflow-hidden rounded-[20px]"
                    style={{
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      width: 12, height: 12, background: C.primary, transform: 'translateX(-50%) rotate(45deg)',
                      ...
                      {dropdownNavItems.map((item) => {
                        ...
                        return (
                          <Link
                            ...
                            style={{
                              color: active ? C.accent : 'white',
                              background: active ? 'rgba(181, 106, 121, 0.05)' : 'transparent',
                              textDecoration: 'none',
                            }}
                            onMouseEnter={e => {
                              e.currentTarget.style.background = 'rgba(181, 106, 121, 0.05)';
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <Link
              to="/trade-enquiry"
              className="hidden lg:inline-flex items-center justify-center px-6 py-2.5  text-[12px] font-bold tracking-wider uppercase shadow-sm hover:shadow-md transition-all duration-300 rounded-full"
              style={{
                background: C.accent,
                color: '#ffffff',
                border: 'none',
              ...
              onMouseEnter={e => {
                e.currentTarget.style.background = 'white'; e.currentTarget.style.color = C.primary;
              }}
              onMouseLeave={e => {
                e.currentTarget.style.background = C.accent; e.currentTarget.style.color = '#ffffff';
              }}
            >
              Trade Enquiry
            </Link>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{ background: C.primary, fontFamily: "'Inter', sans-serif" }}
          >
            {/* Drawer header */}
            <div style={{ padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid rgba(255,255,255,0.05)` }}>
              ...
              <button
                ...
                style={{
                  width: 36, height: 36,
                  background: 'rgba(181, 106, 121, 0.1)',
                  border: 'none',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 pb-28 space-y-2">
              <div className="grid grid-cols-1 gap-2">
                {directNavItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        background: active ? 'rgba(181, 106, 121, 0.1)' : 'transparent',
                        color: active ? C.accent : 'white',
                      }}
                    >
                      <span>{item.name}</span>
                ...
                <div className="w-full">
                  <button
                    ...
                    style={{
                      color: isDropdownActive() ? C.accent : 'white',
                    }}
                  >
                    <span>More</span>
              ...
              <div className="pt-6">
                <Link
                  to="/trade-enquiry"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center gap-2 py-4  text-[13px] font-bold uppercase tracking-wider rounded-full"
