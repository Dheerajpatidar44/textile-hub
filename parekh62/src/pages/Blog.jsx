        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, idx) => (
            <motion.div 
              ...
              className="bg-white rounded-2xl border border-[#E8DFD8] overflow-hidden text-left hover:shadow-md transition-shadow cursor-pointer animate-fade-in"
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-[16px] font-bold text-[#5E4023] mb-4 line-clamp-2 leading-snug font-serif">{post.title}</h3>
                <span className="text-[11px] font-bold text-[#8C6239] tracking-widest uppercase flex items-center gap-1">
