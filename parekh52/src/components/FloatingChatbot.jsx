    ...
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'Outfit', sans-serif" }}>
      {isOpen && (
        <div
          ...
          style={{ borderColor: C.border, background: '#F8FAF9', boxShadow: '0 16px 48px rgba(13, 110, 110, 0.12)' }}
        >
          {/* Header */}
          <div
            ...
            <div className="flex items-start gap-2.5 mb-4">
              ...
              >
                <p className="text-[13px] leading-relaxed" style={{ color: C.soil }}>
                  Namaste! 🙏 Welcome to <strong>SUTRANGI Textiles of India</strong>. How can I assist you today?
                </p>
              </div>
            </div>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 4px 16px rgba(13,110,110,0.2)'
        }}
      >
        {isOpen ? (
