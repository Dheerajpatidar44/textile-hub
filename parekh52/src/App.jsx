      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(13, 110, 110, 0.65)', backdropFilter: 'blur(8px)' }}
          />
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#0D6E6E', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(13, 110, 110, 0.05)'; }}
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C2A478" strokeWidth="1.5">
                  ...
                  <path d="M12 6l-6 6 6 6 6-6-6-6z" stroke="#0D6E6E" strokeWidth="1.5"/>
              ...
              <h2 style={{
                ...
                color: '#0D6E6E', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#0D6E6E', margin: '0 0 4px', lineHeight: 1.2,
              ...
              <h3 style={{
                ...
                color: '#E6A822', margin: '0 0 20px', letterSpacing: '0.25em',
              ...
              <p style={{ color: '#5C7A7A', fontSize: 13, lineHeight: 1.6, margin: '0 0 32px', fontWeight: 500 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#0D6E6E'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#E6A822'; }}
              >
                Explore Collection
              </button>
            </div>
