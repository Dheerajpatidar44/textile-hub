      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 pt-0">
          ...
          {upcomingAuctions.map((auction) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(13, 110, 110, 0.05)';
              }}
              onMouseLeave={e => {
            ...
            >
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <span style={{ fontSize: 9, padding: '6px 12px', background: 'rgba(13, 110, 110, 0.06)', color: C.primary, fontWeight: 700, letterSpacing: '0.1em', borderRadius: '50px' }}>
                    {auction.id}
                  </span>
        ...
        <motion.div
          ...
          style={{
            ...
            overflow: 'hidden',
            borderRadius: 24,
            boxShadow: '0 12px 40px rgba(13, 110, 110, 0.03)',
          }}
        >
            {/* Form Header */}
            <div style={{
                ...
                <div className="mt-4">
                  ...
                  <label
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.background = 'rgba(13, 110, 110, 0.04)';
                    }}
                    onMouseLeave={e => {
