          ...
          {jobs.map((job, idx) => (
            ...
            >
              <div>
                ...
                <div className="flex flex-col gap-3 mb-6">
                  {[
                    ...
                    { icon: Mail, val: 'careers@sutrangitextiles.com', href: 'mailto:careers@sutrangitextiles.com' },
                    ...
                    <div key={val} style={{ color: C.stone }} className="flex items-center gap-2.5 text-[12.5px] font-semibold">
                      ...
                      {href ? (
                        <a href={href} className="hover:text-[#E6A822] transition-colors">{val}</a>
                      ) : (
                        <span>{val}</span>
                      )}
                    </div>
              ...
              <div className="pt-6 mt-4 flex flex-col gap-3" style={{ borderTop: `1px solid ${C.border}` }}>
                <button
                  className="w-full py-3 rounded-xl font-bold text-xs uppercase tracking-widest text-white transition-colors cursor-pointer"
                  style={{
