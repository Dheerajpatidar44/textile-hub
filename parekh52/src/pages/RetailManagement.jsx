    ...
    <div style={{ fontFamily: "'Outfit', sans-serif", background: C.cream, minHeight: '90vh' }} className="pt-2 pb-16">
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 pt-0">
        ...
        <p style={{ textAlign: 'center', fontSize: 14, color: C.stone, marginBottom: 40, fontWeight: 600, maxWidth: 560, margin: '0 auto 40px', lineHeight: 1.6 }}>
          SUTRANGI Textiles of India is administered and governed by highly skilled, experienced and qualified Management with decades of expertise in the textile industry.
        </p>
          ...
          {teamMembers.map((member, i) => (
            <motion.div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 12px 30px rgba(13, 110, 110, 0.04)';
              }}
              onMouseLeave={e => {
            ...
            >
              ...
              <a
                href={`mailto:${member.name.toLowerCase().replace(' ', '')}@sutrangitextiles.com`}
                style={{
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(13, 110, 110, 0.08)'; e.currentTarget.style.color = C.primary; e.currentTarget.style.borderColor = 'rgba(13, 110, 110, 0.15)'; }}
              >
