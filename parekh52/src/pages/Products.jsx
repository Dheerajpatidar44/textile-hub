            ...
            {["All", ...categories].map((cat) => {
              ...
              return (
                <button
                  ...
                  className="px-4 py-2.5 rounded-2xl text-[12px] font-bold tracking-wide transition-all duration-200 cursor-pointer text-center flex items-center justify-center gap-1.5 shadow-sm"
                  style={{
                  ...
                  onMouseEnter={e => {
                    if (!active) {
                      e.currentTarget.style.background = 'rgba(13, 110, 110, 0.05)';
                ...
                >
                  <span>{cat}</span>
                  {active && <div style={{ width: 5, height: 5, borderRadius: '50%', background: C.accent }} />}
                </button>
              );
            })}
          </div>
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  <div style={{ height: 280, overflow: 'hidden', position: 'relative' }}>
                    ...
                    />
                    <div className="absolute inset-0 bg-[#0D6E6E]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none" />
                  </div>
