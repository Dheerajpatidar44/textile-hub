...
const contactDetails = [
  { icon: MapPin, label: 'Headquarters', lines: ['SareeSutra Textile Mall', '123, Textile Market, Surat', 'Gujarat, India - 395002'] },
  { icon: Phone, label: 'Call Us', lines: ['+91 98765 43210', '1800 123 4567'] },
  { icon: Mail, label: 'Email Enquiries', lines: ['hello@sareesutra.com', 'sales@sareesutra.com'] },
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.bg, minHeight: '100vh' }} className="pt-[80px] pb-24">
      <div className="max-w-[85rem] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-16">
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(40px, 5vw, 56px)', fontWeight: 700, color: C.primary, margin: '0 0 16px' }}>
            Get in Touch
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-6">
            {contactDetails.map(({ icon: Icon, label, lines }, idx) => (
              <motion.div
                ...
                key={label}
                className="flex items-start p-6 rounded-2xl bg-white border"
                style={{
              ...
              >
                <div 
                  ...
                  className="rounded-full flex items-center justify-center shrink-0 mr-5"
                >
                  <Icon size={20} color={C.accent} />
                </div>
                <div>
                  <h3 style={{ color: C.primary, margin: '0 0 6px', fontFamily: "'DM Sans', sans-serif" }} className="text-[15px] font-bold tracking-wide uppercase">
                    {label}
                  </h3>
                  {lines.map((line, i) => (
          ...
          <motion.div 
            ...
            className="w-full lg:w-2/3 h-[500px] lg:h-auto rounded-3xl overflow-hidden border shadow-sm relative"
            style={{ 
              borderColor: C.border, 
            }}
          >
            ...
            <iframe
              ...
              title="SareeSutra Textile Mall Location"
            />
          </motion.div>
        </div>
