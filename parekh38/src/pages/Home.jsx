...
import { ArrowRight, FileText, Gavel, Users, BarChart3, Newspaper, Image as ImageIcon, MessageSquare, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div style={{ background: C.bg, fontFamily: "'Inter', sans-serif" }} className="w-full overflow-x-hidden pb-0">
      ...
      <section className="relative w-full mb-16 overflow-hidden">
        <div className="relative w-full h-[400px] lg:h-[550px] flex items-center group">
          ...
          <button 
            onClick={handlePrev}
            className="absolute left-4 lg:left-8 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center bg-black/20 hover:bg-black/40 text-white transition-all backdrop-blur-sm border border-white/20"
          >
            <ChevronLeft size={24} />
          </button>
          ...
          <button 
            onClick={handleNext}
            className="absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 z-20 w-10 h-10 flex items-center justify-center bg-black/20 hover:bg-black/40 text-white transition-all backdrop-blur-sm border border-white/20"
          >
          ...
          <div className="relative z-10 w-full h-full max-w-[90rem] mx-auto pl-16 pr-6 lg:pl-28 lg:pr-14 flex items-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            <div className="w-full lg:w-[50%] pt-32 lg:pt-0 flex flex-col items-start text-left">
              ...
              >
                <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(46px, 5vw, 64px)', fontWeight: 600, color: 'white', lineHeight: 1 }}>
                  WEAVING TRADITION.
                </span>
                <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(46px, 5vw, 64px)', fontWeight: 600, color: 'white', lineHeight: 1 }}>
              ...
              <motion.p
                ...
                style={{ fontFamily: "'Playfair Display', serif", color: 'rgba(255,255,255,0.9)', fontSize: '24px', lineHeight: 1.5, marginTop: 24, marginBottom: 36, maxWidth: 500, fontWeight: 500 }}
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 lg:gap-6">
          {[
            ...
            <Link
              ...
              className="flex flex-col items-center text-center p-6  transition-all duration-300 bg-white"
      ...
      <section className="max-w-[90rem] mx-auto px-6 lg:px-14 py-10 mb-16 relative">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '32px', fontWeight: 600, color: C.primary }}>
              OUR CATEGORIES
            </h2>
            <div style={{ width: 40, height: 1, background: C.accent }} />
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-6 gap-y-10">
          {categories.map((cat, idx) => (
            <Link key={idx} to={`/products?category=${encodeURIComponent(cat.name)}`} className="flex flex-col items-center group">
              <div className="w-28 h-28 lg:w-36 lg:h-36  overflow-hidden mb-4 border-4" style={{ borderColor: C.bg, boxShadow: '0 8px 24px rgba(0,0,0,0.08)', transition: 'all 0.3s' }}>
      ...
      <section className="bg-[#F5EED8]/30 py-20 mb-20 border-y" style={{ borderColor: C.border }}>
        <div className="max-w-[90rem] mx-auto px-6 lg:px-14">
          <div className="flex flex-col md:flex-row items-center justify-between mb-12">
            ...
            <Link to="/products" className="mt-4 md:mt-0 text-[12px] font-bold uppercase tracking-widest px-6 py-2  border transition-all" style={{ borderColor: C.accent, color: C.primary }}>
              View All
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredCollections.map((col, idx) => (
              <div key={idx} className="relative group overflow-hidden  h-[400px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-6">
                  <h3 className="text-white text-[20px] font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>{col.title}</h3>
                  <p className="text-[#E8DCC8] text-[13px] mt-1">{col.subtitle}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-12 lg:gap-24">
          {[
            ...
            <div key={i} className="flex flex-col items-center text-center">
              <div className="text-[36px] font-bold mb-1" style={{ color: C.accent, fontFamily: "'Playfair Display', serif" }}>{stat.val}</div>
      ...
      <section className="max-w-[90rem] mx-auto px-6 lg:px-14 mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { title: "Latest Blog", desc: "Trends, styles & industry insights", bg: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&auto=format&fit=crop&q=80", link: "/blog" },
            { title: "Notice Board", desc: "Important announcements", bg: "https://images.unsplash.com/photo-1582966772680-860e372bb558?w=600&auto=format&fit=crop&q=80", link: "/notice-board" },
            ...
            <Link key={i} to={item.link} className="relative group overflow-hidden  h-[280px]">
              ...
              <div className="absolute inset-0 bg-black/60 group-hover:bg-black/70 transition-colors flex flex-col items-center justify-center p-6 text-center">
                <h3 className="text-white text-[22px] font-bold mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>{item.title}</h3>
                <p className="text-white/80 text-[13px] mb-6">{item.desc}</p>
                <div className="text-[11px] font-bold tracking-widest uppercase border border-white/40 px-6 py-2  text-white transition-all group-hover:bg-white group-hover:text-black">
                  Explore
                </div>
              </div>
            </Link>
      ...
      <section className="bg-[#F5EED8]/40 py-24 border-t" style={{ borderColor: C.border }}>
        <div className="max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '36px', fontWeight: 700, color: C.primary, marginBottom: 16 }}>
          ...
          <Link
            to="/contact"
            className="inline-flex items-center justify-center px-10 py-4  text-[13px] font-bold tracking-wider uppercase transition-all duration-300"
