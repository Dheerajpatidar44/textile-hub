    ...
    >
      ...
      <div
        ...
        style={{
          background: '#F5F6F8',
          backdropFilter: 'none',
          borderBottom: `1px solid rgba(59, 71, 85, 0.08)`,
      ...
      >
        <div className="max-w-[95rem] mx-auto px-4 sm:px-8 lg:pl-6 lg:pr-14 flex justify-between items-center">
          ...
          {/* Logo Brand: KUMAVATI Textile House */}
          <Link to="/" className="flex items-center gap-3 group shrink-0 text-left">
            ...
            <div className="flex flex-col">
              <span
                ...
                style={{ fontFamily: "'Playfair Display', serif", color: useWhiteText ? '#ffffff' : C.primary }}
              >
                KUMAVATI
              </span>
              <span
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    borderRadius: 0,
                    color: active ? C.gold : (useWhiteText ? 'rgba(255, 255, 255, 0.8)' : 'rgba(26, 34, 56, 0.8)'),
                  }}
                  onMouseEnter={e => { e.currentTarget.style.color = C.gold; }}
                  onMouseLeave={e => { if (!active) e.currentTarget.style.color = useWhiteText ? 'rgba(255, 255, 255, 0.8)' : 'rgba(26, 34, 56, 0.8)'; }}
                >
                  {item.name}
                </Link>
              );
            ...
            >
              <button
                ...
                style={{
                  borderBottom: '2px solid transparent',
                  borderRadius: 0,
                  color: isDropdownActive() ? C.gold : (useWhiteText ? 'rgba(255, 255, 255, 0.8)' : 'rgba(26, 34, 56, 0.8)'),
                }}
                onMouseEnter={e => { e.currentTarget.style.color = C.gold; }}
                onMouseLeave={e => { if (!isDropdownActive()) e.currentTarget.style.color = useWhiteText ? 'rgba(255, 255, 255, 0.8)' : 'rgba(26, 34, 56, 0.8)'; }}
              >
                <span>PAGES</span>
                        ...
                        return (
                          <Link
                            ...
                            style={{
                              ...
                              background: active ? (useWhiteText ? 'rgba(255, 255, 255, 0.08)' : 'rgba(59, 71, 85, 0.04)') : 'transparent',
                              textDecoration: 'none',
                              letterSpacing: '0.05em',
                            }}
                            onMouseEnter={e => {
                              e.currentTarget.style.background = useWhiteText ? 'rgba(255, 255, 255, 0.08)' : 'rgba(59, 71, 85, 0.04)';
          ...
          >
            ...
            <div style={{ 
              ...
              <button
                ...
                style={{
                  width: 36, height: 36,
                  background: useWhiteText ? 'rgba(255, 255, 255, 0.1)' : 'rgba(59, 71, 85, 0.05)',
                  border: 'none',
                ...
                {directNavItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        background: active ? (useWhiteText ? 'rgba(255, 255, 255, 0.1)' : 'rgba(59, 71, 85, 0.05)') : 'transparent',
            ...
            <div className="px-6 py-6 border-t border-white/10 flex items-center justify-center gap-4 bg-black/10" style={{ 
              ...
              {[
                ...
                <a
                  ...
                  style={{
                    color: useWhiteText ? '#ffffff' : C.primary,
                    borderColor: useWhiteText ? 'rgba(255, 255, 255, 0.2)' : 'rgba(59, 71, 85, 0.2)',
                  ...
                  onMouseLeave={e => {
                    e.currentTarget.style.borderColor = useWhiteText ? 'rgba(255, 255, 255, 0.2)' : 'rgba(59, 71, 85, 0.2)';
