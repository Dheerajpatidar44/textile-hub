      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            style={{ background: 'rgba(59, 71, 85, 0.4)', backdropFilter: 'blur(8px)' }}
          />
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 40px 80px rgba(59, 71, 85, 0.15)',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: '#5E6A7E', transition: 'all 0.2s',
                borderRadius: '50%',
                zIndex: 5,
              }}
            ...
            <div style={{ padding: '44px 32px 36px', textAlign: 'center' }}>
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifycontent: 'center',
                borderRadius: '50%',
                background: 'rgba(59, 71, 85, 0.1)', }}>
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#3B4755" strokeWidth="1.5">
                  <circle cx="12" cy="12" r="9" stroke="#3B4755" strokeWidth="1.5" />
                  <path d="M12 2v20M2 12h20M5 5l14 14M5 19L14 10" stroke="#3B4755" strokeWidth="1" />
                  <circle cx="12" cy="12" r="4" fill="#3B4755" />
                </svg>
              </div>
              ...
              <h2 style={{
                ...
                color: '#3B4755', margin: '0 0 6px', lineHeight: 1.25,
              ...
              <h2 style={{
                ...
                color: '#3B4755', margin: '0 0 6px', lineHeight: 1.2,
              ...
              <h3 style={{
                ...
                color: '#5E6A7E', margin: '0 0 18px', lineHeight: 1.2,
              ...
              <p style={{ color: '#5E6A7E', fontSize: 13.5, lineHeight: 1.6, margin: '0 0 32px', fontWeight: 500 }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#4E5D6F'; }}
                onMouseLeave={e => { e.currentTarget.style.background = '#3B4755'; }}
              >
                Explore Collection
              </button>
            </div>
      ...
      <AnimatePresence mode="wait">
        {appVisible && (
          <div
            ...
            className="w-full min-h-screen bg-[#F5F6F8]"
          >
            <Routes>
