...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, KUMAVATI Textile House ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <motion.div
                ...
                key={index}
                className="hover:shadow-md hover:border-[#D4B26F]/40 transition-all duration-300"
                style={{
                  background: 'white',
              ...
              >
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: isOpen ? C.accent : 'rgba(59, 71, 85, 0.08)',
