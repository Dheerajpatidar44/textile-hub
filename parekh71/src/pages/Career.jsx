      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-14 pt-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          {jobs.map((job, idx) => (
            ...
            >
              <div>
                <h3 style={{ fontFamily: "'Playfair Display', serif", color: C.soil }} className="text-[20px] font-bold mb-5 leading-snug">
                  {job.title}
                </h3>
                <div className="flex flex-col gap-3 mb-6">
                  {[
                    ...
                    { icon: Mail, val: 'careers@kumavatitextile.com', href: 'mailto:careers@kumavatitextile.com' },
