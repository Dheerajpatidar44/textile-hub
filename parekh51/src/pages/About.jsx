        ...
        >
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-[#2A3B4C]/10 mix-blend-overlay"></div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 text-left">
            ...
            <h2 
              className="text-[34px] lg:text-[42px] font-normal mb-5 leading-tight text-[#2A3B4C]"
            ...
            <p className="text-[13.5px] leading-relaxed text-[#5E6E7D] font-semibold mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-[#E6E4DF] pt-6">
              <div>
                <h4 className="text-[12px] font-bold text-[#2A3B4C] uppercase mb-1">Authentic Quality</h4>
                <p className="text-[11.5px] text-[#5E6E7D] leading-normal font-semibold">Every thread selected represents generations of weave expertise.</p>
              </div>
              <div>
                <h4 className="text-[12px] font-bold text-[#2A3B4C] uppercase mb-1">Modern Service</h4>
                <p className="text-[11.5px] text-[#5E6E7D] leading-normal font-semibold">Leveraging e-auctions and e-quotations for smooth procurement.</p>
              </div>
            </div>
          </div>
        </motion.div>
