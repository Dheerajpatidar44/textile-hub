          ...
          {circulars.map((circular) => (
            ...
            >
              <div className="flex flex-col items-start gap-4 mb-5">
                ...
                <div>
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, color: C.primary, margin: '0 0 6px' }}>{circular.title}</h3>
              ...
              <div className="flex items-center gap-2 pt-4 mt-auto border-t" style={{ borderColor: C.border }}>
                ...
                <button style={{ flex: 1, display: 'flex', alignItems: 'center', justify: 'center', gap: 6, padding: '8px 12px', fontSize: 11, cursor: 'pointer', border: `1.5px solid ${C.border}`, color: C.stone, background: 'transparent', fontFamily: "'DM Sans', sans-serif", transition: 'all 0.2s ease', borderRadius: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em' }}
