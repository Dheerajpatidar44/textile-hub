...
const C = {
  primary: '#1B2A4A',       // Deep Warm Brown
  primaryLight: '#2E4070',  // Medium Warm Brown
  primaryDark: '#0D1828',   // Deep Dark Brown
  accent: '#D4A842',        // Warm Terracotta Gold
  gold: '#D4A842',          // Gold
  bg: '#F8F7F4',            // Warm Cream Background
  border: '#E2DDDA',        // Warm Beige Border
  stone: '#5A5560',         // Muted Warm text
  soil: '#1B2A4A',          // Primary Brown
};
    ...
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      {isOpen && (
        <div
          ...
          style={{ borderColor: C.border, background: '#F5F3EF', boxShadow: '0 16px 48px rgba(107, 66, 38, 0.12)' }}
        >
          {/* Header */}
          <div
          ...
          <div className="p-5 h-64 overflow-y-auto" style={{ background: C.bg }}>
            <div className="flex items-start gap-2.5 mb-4">
              ...
              <div
                className="px-4 py-3 rounded-xl rounded-tl-none max-w-[82%] bg-[#F5F3EF] text-left border"
