...
export default function Footer() {
  return (
    <footer style={{
      background: `linear-gradient(135deg, ${C.primary} 0%, #0D1828 60%, #1a2240 100%)`, 
      ...
      <div style={{ position: 'absolute', top: 0, right: 0, width: 400, height: 400, background: 'radial-gradient(circle, rgba(212, 168, 66, 0.06) 0%, transparent 70%)', filter: 'blur(60px)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: 0, left: 0, width: 300, height: 300, background: 'radial-gradient(circle, rgba(139, 26, 45, 0.08) 0%, transparent 70%)', filter: 'blur(40px)', pointerEvents: 'none' }} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-10 lg:gap-12 text-left mb-12">
          ...
          <div className="col-span-1">
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              <div style={{ width: 44, height: 44, background: 'rgba(255, 255, 255, 0.08)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(212,168,66,0.3)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2L2 7l10 5 10-5-10-5z" stroke="#D4A842" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2 17l10 5 10-5" stroke="#D4A842" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2 12l10 5 10-5" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: '#FFFFFF', lineHeight: 1.1, letterSpacing: '0.02em' }}>
                  Meraki Ethnic
                </div>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              {[
                ...
                <a
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = '#D4A842';
                    e.currentTarget.style.color = '#FFFFFF';
                    e.currentTarget.style.background = '#D4A842';
                    e.currentTarget.style.transform = 'translateY(-2px)';
                    e.currentTarget.style.boxShadow = '0 6px 15px rgba(212, 168, 66, 0.3)';
                  }}
                  onMouseLeave={e => {
          ...
          {/* ── COMPANY Column ── */}
          <div className="col-span-1">
            <h4 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 700, color: C.gold, marginBottom: 20, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              Company
            </h4>
