...
const FloatingChatbot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      {isOpen && (
        <div
          className="mb-4 w-[340px] sm:w-[370px]  overflow-hidden border"
          style={{ borderColor: C.border, background: '#FAF6F1', boxShadow: '0 12px 40px rgba(59, 35, 20, 0.15)' }}
        >
          {/* Header */}
          <div
          ...
          >
            ...
            <button
              ...
              className="p-1.5 hover:bg-white/10  transition-colors text-white"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <div className="p-5 h-64 overflow-y-auto" style={{ background: C.cream }}>
            <div className="flex items-start gap-2.5 mb-4">
              ...
              <div
                className="px-4 py-3   max-w-[82%] bg-white text-left border"
                style={{ borderColor: C.border }}
              >
                <p className="text-[13px] leading-relaxed" style={{ color: C.soil }}>
                  Namaste! ðŸ™ Welcome to <strong>SareeSutra Textile Retail</strong>. How can I assist you today?
                </p>
              </div>
            </div>
          ...
          >
            ...
            />
            <button
              className="w-9 h-9  flex items-center justify-center shrink-0 transition-all duration-200 hover:scale-110 cursor-pointer border"
      ...
      <button
        ...
        className="w-[52px] h-[52px]  flex items-center justify-center cursor-pointer transition-all duration-300 border"
        style={{
          background: isOpen ? C.soil : C.primary,
          borderColor: C.border,
          boxShadow: '0 4px 16px rgba(59, 35, 20, 0.2)'
        }}
      >
        {isOpen ? (
