  ...
  return (
    <div className="fixed left-0 top-[35%] z-[99] flex items-center">
      <motion.div
        ...
        className="flex flex-col items-center  shadow-2xl py-5 px-3.5 relative"
        style={{
          background: 'rgba(86, 81, 62,0.95)',
      ...
      >
        ...
        <button
          ...
          className="absolute right-[-24px] top-1/2 -translate-y-1/2 w-6 h-10 flex items-center justify-center  border-y border-r transition-colors focus:outline-none shadow-md cursor-pointer"
          style={{
            background: '#1B2B3F',
            color: '#ffffff',
