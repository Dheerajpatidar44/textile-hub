...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, Varnika Weaves ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
...
export default function FAQ() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.cream, minHeight: '100vh' }} className="pt-[60px] pb-20">
