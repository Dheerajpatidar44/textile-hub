...
const reviews = [
  { text: "Varnika Weaves has been our trusted partner for years. The quality, prices and service are unmatched in the entire industry.", name: "Rajesh Sharma", role: "Retailer, Delhi", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" },
...
export default function CustomerReview() {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.cream }} className="pt-[60px] pb-20">
